...
Release notes: [docs/changenotes/v1.0.3.md](docs/changenotes/v1.0.3.md)

| Version | Notes |
|---------|-------|
| [v1.0.3](docs/changenotes/v1.0.3.md) | Anomaly-ID cap at 128 entities; `fdir_health_snapshot_copy()`; threading docs |
